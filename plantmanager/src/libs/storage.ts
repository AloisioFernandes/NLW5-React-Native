  ...
  try {
    ...
    await AsyncStorage.setItem('@plantmanager:plants', 
      JSON.stringify({
        ...newPlant,
        ...oldPlants
      }) // mantém plantas antigas e adiciona nova planta cadastrada
    )
  }catch(error){
...
export async function removePlant(id: string) : Promise<void> {
  ...
  await Notifications.cancelScheduledNotificationAsync(plants[id].notificationId) // cancela notificação
